...
# - Modification of config and checkpoint to support legacy models
# - Add inference mode and HRDA output flag
# - (NEW) Robust checkpoint loading:
#   * drops EMA keys by default
#   * optional --use-ema to load EMA weights into the normal modules
#   * fixes backbone prefix mismatch: backbone.*  -> backbone.model.* (timm wrapper)
#   * still strips module. and model. prefixes
